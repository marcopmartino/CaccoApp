...
class CustomEdgeInsets extends EdgeInsets {
  const CustomEdgeInsets.all(super.value) : super.all();
  const CustomEdgeInsets.fromLTRB(super.left, super.top, super.right, super.bottom) : super.fromLTRB();
  const CustomEdgeInsets.only({super.left, super.top, super.right, super.bottom}) : super.only();
  const CustomEdgeInsets.symmetric({super.horizontal, super.vertical}) : super.symmetric();
